                            ...
                            <div class="message-wrapper">
                                <div class="single-item-message">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control details-area" id="firma_sifre_eski" name="firma_sifre_eski" type="password">
                                        </div>
                                    </div> <br>
                                </div>
                                <div class="single-item-message">
                                ...
                                <div class="single-item-message">
                                    <div class="leave-comments-message">
                                        <div class="leave-comments-box">
                                            <button onclick="firmasifreGuncelle('sifre-guncelle-form','firma-sifre-guncelle');return false;" class="update-btn">Kaydet</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
